 ...
 */
public class FakeAdventureTeamServiceImpl extends AdventureTeamServiceImpl {

    public FakeAdventureTeamServiceImpl(AbstractTeamRepository repository) {
        super(repository);
    }
    ...
    public Team createATeam(String name, User teamLeader, List<User> teamMembers) {
        return new Team(name,TeamType.ADVENTURE,teamLeader,teamMembers);
    }
}
